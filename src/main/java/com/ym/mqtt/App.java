...
// private static String broker = "tcp://iad.raftis.cn:1883";
...
private static void pub(MqttClient sampleClient, String msg,String topic) 
    ...
    MqttTopic topics = sampleClient.getTopic(topic);
    MqttDeliveryToken token = topics.publish(message);
...
public static void main(String[] args) throws MqttException {
    ...
    publish("message content","client-id-0","zam");
}
}
